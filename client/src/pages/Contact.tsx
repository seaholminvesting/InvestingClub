        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Have questions about joining our club or want to learn more about
              our programs? Reach out to us directly!
            </p>
          </motion.div>
            ...
            >
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Ready to start your investing journey? Join us for our weekly
                  meetings and discover the world of finance and investing with
                  fellow Seaholm students.
                </p>
